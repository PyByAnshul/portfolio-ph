      ...
      <div className="max-w-5xl mx-auto flex flex-col">
        {services.map((service, idx) => (
          <FadeIn key={idx} delay={idx * 0.1} y={20}>
            <div className="flex gap-6 sm:gap-8 md:gap-12 py-8 sm:py-10 md:py-12 border-b border-[rgba(12,12,12,0.15)]">
              ...
              <div className="flex-1 flex flex-col justify-center">
                <h3 className="text-[#0C0C0C] font-medium uppercase text-[clamp(1rem,2.2vw,2.1rem)] mb-3 tracking-tight">
                  {service.name}
                </h3>
